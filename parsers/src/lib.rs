...
pub const EXTENSIONS: &[&str] = &["ada", "adb", "ads", "apex", "asm", "awk", "bash", "bat", "bicep", "blade", "build", "bzl", "c", "c++", "cairo", "capnp", "cbl", "cc", "cfc", "cfm", "cjs", "cl", "clj", "cljc", "cljs", "cls", "clsp", "cmake", "cmd", "cob", "comp", "cpp", "cpy", "cql", "cr", "cs", "css", "cts", "cu", "cxx", "cypher", "d", "dart", "ddl", "dockerfile", "dtx", "edn", "el", "elm", "erl", "ets", "ex", "exs", "f", "f03", "f08", "f90", "f95", "fbs", "fish", "fnl", "for", "frag", "fs", "fsi", "fsx", "gd", "gemspec", "geom", "gleam", "glsl", "go", "gql", "gradle", "graphql", "groovy", "gsh", "gvy", "gy", "h", "h++", "ha", "hcl", "hh", "hlsl", "hpp", "hrl", "hs", "htm", "html", "hxx", "ins", "ispc", "j2", "janet", "java", "jl", "js", "json", "json5", "jsonc", "jsonnet", "jsx", "just", "kt", "kts", "latex", "lean", "less", "lhs", "liquid", "lisp", "ll", "lsp", "ltx", "lua", "luau", "m", "mac", "markdown", "matlab", "md", "mjs", "mk", "ml", "mli", "mm", "mojo", "move", "mts", "nim", "nix", "nut", "oct", "odin", "pas", "php", "php3", "php4", "php5", "php7", "php8", "phps", "phtml", "pl", "plist", "pls", "pm", "pony", "pp", "prisma", "proto", "ps1", "psd1", "psm1", "purs", "py", "pyi", "qml", "r", "rahit", "rake", "rb", "rcall", "rchit", "res", "rgen", "rint", "rkt", "rmiss", "rs", "sc", "scala", "scheme", "scm", "scss", "sh", "smali", "sol", "soql", "sosl", "sql", "sty", "sv", "svelte", "svg", "svh", "swift", "tcl", "templ", "tesc", "tese", "tex", "tf", "tfvars", "thrift", "tl", "tla", "tmpl", "toml", "trigger", "ts", "tsx", "typ", "v", "vb", "vbs", "vert", "vhd", "vhdl", "vim", "vue", "wast", "wat", "wgsl", "wl", "wsdl", "xaml", "xml", "xsd", "yaml", "yml", "zig", "zsh"];
...
impl Language {
    ...
    pub fn from_extension(ext: &str) -> Option<Self> {
        match ext.to_lowercase().as_str() {
            ...
            "php" | "phtml" | "php3" | "php4" | "php5" | "php7" | "php8" | "phps" => Some(Self::Php),
            ...
            "wgsl" | "glsl" | "hlsl" | "vert" | "frag" | "geom" | "comp" | "tesc" | "tese" | "rgen" | "rint" | "rahit" | "rchit" | "rmiss" | "rcall" => Some(Self::Shader),
